...
from blog.models import Post, Category, Tag, Goverment
...
@blog_app.route('/details/<detail_id>')
def details(detail_id):
    if int(detail_id) > 3:
        abort(404)
    return render_template('blog/carousel_details.html', detail_id=detail_id)
